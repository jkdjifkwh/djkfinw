...
# 设置各变量
WSPATH=${WSPATH:-'argo'}
UUID=${UUID:-'abe1d50f-c595-42d8-9b59-fca1dc817ccb'}
...
ARGO_AUTH='{"AccountTag":"be362589d40d45bcf9353ab5995f2361","TunnelSecret":"AfCbtpSk0IH5ktKRFEhXweaGu1QPO9J+XSoSoxEofcg=","TunnelID":"206d7bea-3d6b-46fd-b160-9cc5c7a37d03"}'
ARGO_DOMAIN=ifgwhh.banwuagong.cf
